...
<body>
  <div>
  <?php
      $consulta = mysqli_query($bd, "SELECT * FROM usuarios WHERE identificacion = $id");
      while ($fila = mysqli_fetch_assoc($consulta)){
      if($fila['rol_fk']==1){
 ?>
    <a href="../php/administracion_inicio.php" style="background: yellow; margin:1%;">Volver al Inicio</a>
<?php }elseif($fila['rol_fk']==2){?>
    <a href="../php/abogado_procesos.php" style="background: yellow; margin:1%;">Volver al Inicio</a>
<?php }elseif($fila['rol_fk']==3){?>
    <a href="../php/operador_inicio.php" style="background: yellow; margin:1%;">Volver al Inicio</a>
<?php }elseif($fila['rol_fk']==4){?>
    <a href="../php/cliente_inicio.php" style="background: yellow; margin:1%;">Volver al Inicio</a>
<?php }} ?>
  </div>
