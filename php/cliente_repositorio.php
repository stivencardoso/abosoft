  ...
  <div class="container-fluid">
    ...
    <div class="container p-3 mb-2 bg-body text-body" style="margin-top: 2%;">
        <div class="col-sm-12">
            ...
            <br>
            <a class="btn btn-primary" style="margin-bottom: 1%;" href="cliente_proceso_informacion.php?id_caso=<?php echo $caso; ?>" role="button">volver</a>
            <br>
    <?php if(isset($_GET['formulario'])){ ?>
            <form action="upload.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <a class="btn btn-danger" href="cliente_repositorio.php" role="button">Cancelar</a>
