...
<nav class="navbar navbar-expand-lg bg-black">
  <div class="container-fluid text-white">
    ...
    <?php 
      ...
      <form action="formulario_accion.php" class="col-11 col-sm-9 col-md-6 p-3 mb-2 bg-light-subtle text-emphasis-light rounded" method="POST">
        <div class="row" style="margin: 1%;">
            ...
            <div class="col-6">
              ...
              <input type="numer" class="form-control" id="inputAddress2" name="telefono">
            </div>
            <div class="col-12">
            ...
            <div class="col-12" style="margin-bottom: 5%; margin-top: 3%;">
                <select class="form-select" aria-label="Default select example" name="drone">
                    <option selected>Elije el Tipo de Usuario....</option>
            ...
            <div class="text-end" style="margin-top: 3%;">
                <a class="btn btn-secondary" href="administracion_inicio.php" role="button">Volver a Inicio</a>
